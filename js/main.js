    ...
    if (state == "open") {
        setTimeout(function () {
            if (!document.body.hasAttribute("data-body-scroll-fix")) {
                let scrollPosition =
                    window.pageYOffset || document.documentElement.scrollTop; // Получаем позицию прокрутки
...
for (let menuBtn of menuBtns) {
    function changePage() {
        ...
        if (!document.querySelector(".idc-page.open")) {
            ...
            document.querySelector(".idc-page.open").classList.remove("open");
            pageId.classList.add("open");
        }
    }
...
for (let projectBtn of projectBtns) {
    projectBtn.addEventListener("click", function (e) {
        e.preventDefault();
        document.querySelector("#idc-projects.open").classList.remove("open");
